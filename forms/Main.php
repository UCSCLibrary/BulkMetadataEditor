 ...
 *
 * This Omeka curator form collects information defining a set of bulk edits to
 * perform on the omeka database. It includes functionality to perform the
 * changes, and to return preview of the affected records.
 *
...
class SedMeta_Form_Main extends Omeka_Form
{
    ...
    private function _registerElements()
    {
        ...
        // Not actually a text element, but rendered with its own viewscript so
        // it doesn't matter.
        ...
        // The following elements will be re-ordered in javascript gotta create
        // a new element that can be hidden and shown and junk?
    ...
    /**
     * Overrides standard omeka form behavior to tweak display and fix radio
