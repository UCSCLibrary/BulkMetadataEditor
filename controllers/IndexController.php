 ...
 *
 * This controller enforces selection rules on items and metadata elements, and
 * performs various builk editing operationson the database of element texts
 * associated with Omeka items.
 * This class contains the bulk of the functionality of theSedmeta plugin.
 *
...
class SedMeta_IndexController extends Omeka_Controller_AbstractActionController
{
     ...
     * Regardless, it populates the arrays of options for the view's dropdown
     * menus.
     *
     * @return void
     */
     ...
     *
     * @param void
     * @return array $elementOptions Array of options for a dropdown menu
     * containing all elements applicable to records of type Item.
     */
...
//        $options = array('' => __('Select Below'));
     ...
     *
     * @param void
     * @return array $elementIds Array of all element IDs applicable to records
     * of type Item.
     */
     ...
     *
     * @param void
     * @return array $collectionOptions Array of all collections and their IDs,
     * which will be used to populate a dropdown menu on the main view.
     */
     ...
     *
     * Retrieve an array to be used in formSelect() containing all comparison
     * operators supported by this plugin.
     *
     * @param void
                ...
                switch($_REQUEST['changesRadio']) {
                    ...
                    case 'replace' :
                        ...
                        if (!isset($_REQUEST['sedmetaSearch']) || !isset($_REQUEST['sedmetaReplace'])) {
                            throw new Exception("Please define search and replace terms");
                        }
    ...
    private function _getItems($max = 0)
    {
        ...
        if (count($rules) > 0) {
            ...
            foreach ($items as $item) {
                ...
                // Each rule can eliminate items by setting this variable to false
                $matched = true;
                ...
                foreach ($rules as $rule) {
                    ...
                    foreach ($compareTexts as $compareText) {
                        ...
                        if ($match === false) {
                            throw new Exception('Unable to parse regular expression');
                        }
                        //TODO proper error handling
                ...
                // If none of the rules has excluded this item include it in the
     ...
     * @return array $itemData The title, description, type and ID of the given
